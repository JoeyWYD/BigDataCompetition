...
public class WordCount {
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException, InterruptedException {
        ...
        FileInputFormat.addInputPath(job, new Path("C:\\Users\\WuYid\\work\\workspace\\IdeaProjects\\BigDataCompetition\\WordCount\\data\\input\\words.txt"));
        FileOutputFormat.setOutputPath(job, new Path("C:\\Users\\WuYid\\work\\workspace\\IdeaProjects\\BigDataCompetition\\WordCount\\data\\output\\words"));
